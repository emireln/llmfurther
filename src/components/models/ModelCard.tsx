...
export const ModelCard: React.FC<ModelCardProps> = ({
  ...
  return (
    <div
      ...
      className={`group relative flex flex-col justify-between rounded-lg border bg-white dark:bg-neutral-900 transition-all duration-150 cursor-pointer overflow-hidden p-4 ${
        isCompared
    ...
    >
        ...
        <div className="flex items-center justify-between gap-2 mb-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span
              ...
              title={isOperational ? t.status.operational : t.status.degraded}
            />
            {/* Compare toggle */}
            <button
              type="button"
      ...
      <div className="mt-4 pt-2.5 flex items-center justify-between gap-2 border-t border-neutral-100 dark:border-neutral-800/80 text-xs">
        <button
          onClick={handleCopy}
          className="inline-flex items-center gap-1 text-[11px] font-mono text-neutral-500 hover:text-neutral-900 dark:hover:text-neutral-200 transition-colors py-1 px-1.5 rounded hover:bg-neutral-100 dark:hover:bg-neutral-800"
          title="Copy Model ID"
        >
          {copied ? (
            <>
        ...
        <div className="flex items-center gap-2">
          {model.url && (
            <a
              ...
              className="inline-flex items-center gap-1 text-[11px] font-mono font-medium text-accent hover:text-accent-hover transition-colors py-1 px-2 rounded bg-accent/10 border border-accent/20 hover:bg-accent/20"
