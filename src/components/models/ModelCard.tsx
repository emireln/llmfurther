    ...
    >
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <div className="flex flex-wrap items-center gap-1.5 mt-3">
          ...
          {contextDisplay && (
            <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-neutral-900 text-white dark:bg-neutral-800 dark:text-neutral-200 border border-neutral-900 dark:border-neutral-700 font-semibold">
              {contextDisplay}
            </span>
          )}
        ...
        <div className="mt-3 pt-2.5 border-t border-neutral-200 dark:border-neutral-800 min-h-[44px] flex items-center">
          <div className="flex items-start gap-1.5 text-xs text-neutral-800 dark:text-neutral-200">
            ...
            <span className="line-clamp-2 leading-relaxed font-sans text-[12px]">
              {translateQuota(model.freeLimit, language) || t.card.freeAccessAvailable}
            </span>
          </div>
        </div>
      </div>
